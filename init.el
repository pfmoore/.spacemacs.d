...
values."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '(("Source Code Pro-12" :powerline-scale 1.1)
                               ("DejaVu Sans Mono-12" :powerline-scale 1.1)
                               ("Consolas-12" :powerline-scale 1.1)
                               ("Courier New-12" :powerline-scale 1.1))
...
`dotspacemacs/user-config' first."
  ...
  (when (string= system-name "MC0X5FSC")
...
you should place your code here."
  ...
  (setq user-full-name "Paul Moore"
        user-mail-address "p.f.moore@gmail.com")
